...
public class HiddenMoon extends LunarEvent {
    public NyxUtil util = new NyxUtil(this.world);
    ...
    public ITextComponent getStartMessage() {
        return new TextComponentTranslation("info.ra.hidden_moon", new Object()).setStyle(new Style().setColor(TextFormatting.BLACK));
    }
    ...
    public void test() {
        util.outPut();
        System.out.print("HiddenMoon is loaded!");
    }
}
